...
var Tooltip = require('float-tooltip');
...
var sunburst = Kapsule__default["default"]({
  ...
  init: function init(domNode, state) {
    ...
    state.tooltip = Tooltip__default["default"]()(el); // Reset focus by clicking on canvas
  ...
  update: function update(state) {
    ...
    var oldSlice = slice.exit().transition(transition).remove();
